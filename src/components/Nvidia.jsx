                    ...
                    <div className='row py-md-5 py-4 mt-2 justify-content-center'>
                        <div data-aos="fade-up" className="col_xlg_4 col-md-6 col-sm-9">
                            <div className=' card1_sec1 d-flex flex-column justify-content-between h-100'>
                                <p className=' color-black1 fw-normal lh-30 ff-inter fs-md'> <span className='fw-bold'>Nvidia stock</span> shows exceptional technical strength and boasts a best-possible score of 99 on both its Composite Rating and EPS Rating. Its Relative Strength Rating of 98 also shows that its outperforming.</p>
                        ...
                        <div data-aos="fade-up" className="col_xlg_4 col-md-6 col-sm-9 mt-4 mt_xlg_0">
                            <div className=' card1_sec1 px-3 d-flex flex-column justify-content-between h-100'>
                                <p className=' color-black1 fw-normal lh-30 ff-inter fs-md2'>SoftBank will reportedly invest nearly $1 billion in AI push, tapping
