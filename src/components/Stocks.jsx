...
const Stocks = () => {
    return (
        <>
            <section className=' px-md-3 pb-lg-5 mb-lg-5'>
                                ...
                                <div className="col-lg-6 col-md-7 mt-4 mt-md-0">
                                    ...
                                    <div className='btn_stocks mx-auto mt-md-2 mx-md-0'>
                                        <div className='bg_btn_stock'>
                                            <button className=' text-nowrap btn-read fw-bold ff-inter' >Read More</button>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-5 text-center">
                                    <img src={nvidia} alt="img" className=' w-100 img_nvidia' />
                                </div>
                            </div>  
                        </div> 
